...
namespace PrimeiroAppADO.NET
{
    ...
    public class Banco
    {
        private string stringConexao = "Data Source=localhost; Initial Catalog=empresa_db; User ID=rafael; password=abc123;language=Portuguese";
